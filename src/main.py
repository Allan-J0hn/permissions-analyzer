...
# List of Android dangerous (Runtime permissions)  permissions
DANGEROUS_PERMISSIONS = {
	...
	"android.permission.PROCESS_OUTGOING_CALLS android.permission.READ_CELL_BROADCASTS",
	...
	"android.permission.READ_PHONE_NUMBERS android.permission.READ_MEDIA_VISUAL_USER_SELECTED android.permission.NEARBY_WIFI_DEVICES",
